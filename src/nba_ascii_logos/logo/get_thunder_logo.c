/**
 * @file get_thunder_logo.c
 * 
 * @author Mehmet Mert Gunduz (mmertgunduz@protonmail.com)
 * @brief Draw the Oklahoma City Thunder logo and color it by using ANSI color code.
 * 
 * This function is used to construct a colored ASCII representation of Oklahoma City Thunder (OKC) team logo.
...
// Oklahoma City Thunder (OKC) logo colors.
#define OKC_BLUE     "\e[38;2;0;125;195m"   // Hex: #007DC3
#define OKC_ORANGE   "\e[38;2;239;59;36m"   // Hex: #EF3B24

/**
 * @brief Get the Oklahoma City Thunder logo in ASCII format and makes it colorful.
 * 
 * @return char* Oklahoma City Thunder (OKC) logo in colored ASCII format.
 */
char *get_thunder_logo() {
    char thunder_logo[] = 
"          ++       %#%   %% %%%   #%+      -\n\
          ###  %%%%%%%   %%#%%%  +%%%%%%\n\
       #%%%%%   %%%%%%   %%#%%%  %%*%%%#  %%%%%%\n\
  ...
  %%%%  ##%%%%%  %%% %%  %#%#%% #%+###* %%*     %%% %%#\n\
   %%%%  %%%%%%% %%* %%= %#%%%# %%%%%% #%%%%%  %%% %%#\n\
    ...
    for (int i = 0; i < len; i++) {
        ...
        add_colorful_char(colorful_logo, c, OKC_BLUE);
    }
