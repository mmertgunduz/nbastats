/**
 * @file get_hawks_logo.c
 * 
 * @author Mehmet Mert Gunduz (mmertgunduz@protonmail.com)
 * @brief Draw the Atlanta Hawks logo and color it by using ANSI color code.
 * 
 * This function is used to construct a colored ASCII representation of Atlanta Hawks (ATL) team logo.
...
// Atlanta Hawks (ATL) logo colors.
#define ATL_RED     "\e[38;2;200;16;46m"   // Hex: #C8102E
#define ATL_WHITE   "\e[38;2;255;255;255m" // Hex: #FFFFFF

/**
 * @brief Get the Atlanta Hawks logo in ASCII format and makes it colorful.
 * 
 * @return char* Atlanta Hawks (ATL) logo in colored ASCII format.
 */
char *get_hawks_logo() {
    char hawks_logo[] = 
"               .............\n\
  ...
  ..*##########**+::..-*####*=....*###*..\n\
   ..*#####+-....  .  :#*+=.....-*###+..\n\
    ...
    for (int i = 0; i < len; i++) {
        ...
        if (c[0] == '#') {
            add_colorful_char(colorful_logo, c, ATL_RED);
        } else {
            add_colorful_char(colorful_logo, c, ATL_WHITE);
        }
    }
