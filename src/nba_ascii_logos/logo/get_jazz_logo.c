/**
 * @file get_jazz_logo.c
 * 
 * @author Mehmet Mert Gunduz (mmertgunduz@protonmail.com)
 * @brief Draw the Utah Jazz logo and color it by using ANSI color code.
 * 
 * This function is used to construct a colored ASCII representation of Utah Jazz (UTA) team logo.
...
// Utah Jazz (UTA) logo colors.
#define UTA_PURPLE "\e[38;2;62;38;128m" // Hex: #3E2680  

/**
 * @brief Get the Utah Jazz logo in ASCII format and makes it colorful.
 * 
 * @return char* Utah Jazz (UTA) logo in colored ASCII format.
 */
char *get_jazz_logo() {
    char jazz_logo[] = 
"                   %%%%%%%%%%%%%%%%%%%\n\
 ...
 %%%%%%%%%%%%%\n\
  %%%%%%%%%%";
    ...
    for (int i = 0; i < len; i++) {
        ...
        add_colorful_char(colorful_logo, c, UTA_PURPLE);
    }
